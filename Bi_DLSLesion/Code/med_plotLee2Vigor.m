...
hl4 = plot([4.25 5],[GAS_trial.mean_Cor_S(GAS_trial.Group=="Pre"),GAS_trial.mean_Cor_S(GAS_trial.Group=="Post")],'-','lineWidth',0.6,'color',cGreen,'markersize',4,'markerFaceColor',cGreen,'markerEdgeColor','none');
plot([4.25 5],[GAS_trial.mean_Cor_M(GAS_trial.Group=="Pre"),GAS_trial.mean_Cor_M(GAS_trial.Group=="Post")],'-','lineWidth',1,'color',cGreen,'markersize',4,'markerFaceColor',cGreen,'markerEdgeColor','none');
plot([4.25 5],[GAS_trial.mean_Cor_L(GAS_trial.Group=="Pre"),GAS_trial.mean_Cor_L(GAS_trial.Group=="Post")],'-','lineWidth',1.5,'color',cGreen,'markersize',4,'markerFaceColor',cGreen,'markerEdgeColor','none');
hl5 = plot([5.25 6],[GAS_trial.mean_Pre_S(GAS_trial.Group=="Pre"),GAS_trial.mean_Pre_S(GAS_trial.Group=="Post")],'-','lineWidth',0.6,'color',cRed,'markersize',4,'markerFaceColor',cRed,'markerEdgeColor','none');
...
hl6 = plot([6.25 7],[GAS_trial.mean_Late_S(GAS_trial.Group=="Pre"),GAS_trial.mean_Late_S(GAS_trial.Group=="Post")],'-','lineWidth',0.6,'color',cGray,'markersize',4,'markerFaceColor',cGray,'markerEdgeColor','none');
...
text([1.875,5.625],repelem(-0.125,2),{'Session','Trial'},'HorizontalAlignment','center','fontsize',8,'FontName','Arial');
ylabel('Percentage (%)','Fontsize',8,'FontName','Arial');

le1 = legend([hl4,hl5,hl6,hl1,hl2,hl3],{'Correct','Premature','Late','FP 0.5 s','FP 1.0 s','FP 1.5 s'},'Fontsize',8,'fontname','Arial','units','centimeters',...
    'Position',[xs2(3)+size1(1)+0.55,ys(1)+0.1,1,2]);% [4.7,2.8,1,1]
le1.ItemTokenSize = [12,22];
le1.Position = le1.Position + [0.025 0.045 0 0];
legend('boxoff');
...
ha6 = axes;
set(ha6, 'units', 'centimeters', 'position', [xs2(2) ys(1) 3.5*0.7 3.5*0.7], 'nextplot', 'add','tickDir', 'out',...
...
h62 = errorbar(EES_trial.TBT.RT(EES_trial.TBT.Group=="Pre"),EES_trial.TBT.RT(EES_trial.TBT.Group=="Post"),...
    ...
    '.','MarkerSize',4,'MarkerEdgeColor',cGray,'color',cGray,'lineWidth',1,'CapSize',1);


le6 = legend([h61,h62],{'Session','Trial'},'Fontsize',6,'FontName','Arial','units','centimeters','Position',[xs2(2)+3.5*0.7+0.25,ys(1)+0.7,1,1]);
legend('boxoff');
...
ha1 = axes;
set(ha1, 'units', 'centimeters', 'position', [xs2(1) ys(1) 3.5*0.7 3.5*0.7], 'nextplot', 'add','tickDir', 'out',...
   'fontsize',7,'fontname','Arial','xlim',[0.14 0.46],'ylim',[0.14 0.46],'xtick',[0.15,0.25,0.35,0.45],'xticklabel',{'150','250','350','450'},...
   'ytick',[0.15,0.25,0.35,0.45],'yticklabel',{'150','250','350','450'}, 'ticklength', [0.02 0.025]); %
...
xlabel('Pre RelT (ms)','Fontsize',8,'FontName','Arial');
ylabel('Post RelT (ms)','Fontsize',8,'FontName','Arial');
...
ylabel('Release time (ms)','Fontsize',8,'FontName','Arial')
